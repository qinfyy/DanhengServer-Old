    ...
    static ChessRogueUpdateActionPointScNotifyReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "b25fcG9pbnQYCSABKA1CHqoCG0VnZ0xpbmsuRGFuaGVuZ1NlcnZlci5Qcm90",
            "b2IGcHJvdG8z"));
  ...
  #endif
  {
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (ActionPoint != 0) {
        ...
        output.WriteUInt32(ActionPoint);
      }
      if (_unknownFields != null) {
    ...
    public int CalculateSize() {
      int size = 0;
      if (ActionPoint != 0) {
        size += 1 + pb::CodedOutputStream.ComputeUInt32Size(ActionPoint);
      }
      if (_unknownFields != null) {
