...
namespace EggLink.DanhengServer.Proto {
    ...
    static MonopolyActionResultScNotifyReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "Tm90aWZ5EioKC01JRkRIREJHQ0FGGAYgAygLMhUuTW9ub3BvbHlBY3Rpb25S",
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EggLink.DanhengServer.Proto.MonopolyActionResultScNotify), global::EggLink.DanhengServer.Proto.MonopolyActionResultScNotify.Parser, new[]{ "MIFDHDBGCAF" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public MonopolyActionResultScNotify(MonopolyActionResultScNotify other) : this() {
      mIFDHDBGCAF_ = other.mIFDHDBGCAF_.Clone();
    ...
    /// <summary>Field number for the "MIFDHDBGCAF" field.</summary>
    public const int MIFDHDBGCAFFieldNumber = 6;
    private static readonly pb::FieldCodec<global::EggLink.DanhengServer.Proto.MonopolyActionResult> _repeated_mIFDHDBGCAF_codec
        = pb::FieldCodec.ForMessage(50, global::EggLink.DanhengServer.Proto.MonopolyActionResult.Parser);
    private readonly pbc::RepeatedField<global::EggLink.DanhengServer.Proto.MonopolyActionResult> mIFDHDBGCAF_ = new pbc::RepeatedField<global::EggLink.DanhengServer.Proto.MonopolyActionResult>();
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public pbc::RepeatedField<global::EggLink.DanhengServer.Proto.MonopolyActionResult> MIFDHDBGCAF {
      get { return mIFDHDBGCAF_; }
    }
    ...
    public bool Equals(MonopolyActionResultScNotify other) {
      ...
      if(!mIFDHDBGCAF_.Equals(other.mIFDHDBGCAF_)) return false;
    ...
    #else
      mIFDHDBGCAF_.WriteTo(output, _repeated_mIFDHDBGCAF_codec);
      if (_unknownFields != null) {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      mIFDHDBGCAF_.WriteTo(ref output, _repeated_mIFDHDBGCAF_codec);
      if (_unknownFields != null) {
    ...
    public int CalculateSize() {
      int size = 0;
      size += mIFDHDBGCAF_.CalculateSize(_repeated_mIFDHDBGCAF_codec);
      if (_unknownFields != null) {
    ...
    public void MergeFrom(MonopolyActionResultScNotify other) {
      ...
      mIFDHDBGCAF_.Add(other.mIFDHDBGCAF_);
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          default:
            ...
            break;
          case 50: {
            mIFDHDBGCAF_.AddEntriesFrom(input, _repeated_mIFDHDBGCAF_codec);
            break;
          }
        }
      }
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          default:
            ...
            break;
          case 50: {
            mIFDHDBGCAF_.AddEntriesFrom(ref input, _repeated_mIFDHDBGCAF_codec);
            break;
          }
        }
      }
