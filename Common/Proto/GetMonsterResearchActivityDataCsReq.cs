...
namespace EggLink.DanhengServer.Proto {
    ...
    static GetMonsterResearchActivityDataCsReqReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "CiNHZXRNb25zdGVyUmVzZWFyY2hBY3Rpdml0eURhdGFDc1JlcRITCgtQQkZL",
            "TUNNSk9CQhgDIAMoDUIeqgIbRWdnTGluay5EYW5oZW5nU2VydmVyLlByb3Rv",
            "YgZwcm90bzM="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { },
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EggLink.DanhengServer.Proto.GetMonsterResearchActivityDataCsReq), global::EggLink.DanhengServer.Proto.GetMonsterResearchActivityDataCsReq.Parser, new[]{ "PBFKMCMJOBB" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public GetMonsterResearchActivityDataCsReq(GetMonsterResearchActivityDataCsReq other) : this() {
      pBFKMCMJOBB_ = other.pBFKMCMJOBB_.Clone();
    ...
    /// <summary>Field number for the "PBFKMCMJOBB" field.</summary>
    public const int PBFKMCMJOBBFieldNumber = 3;
    private static readonly pb::FieldCodec<uint> _repeated_pBFKMCMJOBB_codec
        = pb::FieldCodec.ForUInt32(26);
    private readonly pbc::RepeatedField<uint> pBFKMCMJOBB_ = new pbc::RepeatedField<uint>();
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public pbc::RepeatedField<uint> PBFKMCMJOBB {
      get { return pBFKMCMJOBB_; }
    }
    ...
    public bool Equals(GetMonsterResearchActivityDataCsReq other) {
      ...
      if(!pBFKMCMJOBB_.Equals(other.pBFKMCMJOBB_)) return false;
    ...
    #else
      pBFKMCMJOBB_.WriteTo(output, _repeated_pBFKMCMJOBB_codec);
      if (_unknownFields != null) {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      pBFKMCMJOBB_.WriteTo(ref output, _repeated_pBFKMCMJOBB_codec);
      if (_unknownFields != null) {
    ...
    public int CalculateSize() {
      int size = 0;
      size += pBFKMCMJOBB_.CalculateSize(_repeated_pBFKMCMJOBB_codec);
      if (_unknownFields != null) {
    ...
    public void MergeFrom(GetMonsterResearchActivityDataCsReq other) {
      ...
      pBFKMCMJOBB_.Add(other.pBFKMCMJOBB_);
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 26:
          case 24: {
            pBFKMCMJOBB_.AddEntriesFrom(input, _repeated_pBFKMCMJOBB_codec);
            break;
          }
        }
      }
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 26:
          case 24: {
            pBFKMCMJOBB_.AddEntriesFrom(ref input, _repeated_pBFKMCMJOBB_codec);
            break;
          }
        }
      }
