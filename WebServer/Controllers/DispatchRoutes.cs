...
namespace EggLink.DanhengServer.WebServer.Controllers
{
    ...
    public class DispatchRoutes
    {
        ...
        public string RiskyCheck() => "{\"retcode\":0,\"message\":\"OK\",\"data\":{\"id\":\"none\",\"action\":\"ACTION_NONE\",\"geetest\":null}}";
        ...
        public string GetExtList() => "{\"retcode\":0,\"message\":\"OK\",\"data\":{\"code\":200,\"msg\":\"ok\",\"ext_list\":[],\"pkg_list\":[],\"pkg_str\":\"/vK5WTh5SS3SAj8Zm0qPWg==\"}}";

        [HttpPost("/data_abtest_api/config/experiment/list")]
        public string GetExperimentList() => "{\"retcode\":0,\"success\":true,\"message\":\"\",\"data\":[{\"code\":1000,\"type\":2,\"config_id\":\"14\",\"period_id\":\"6125_197\",\"version\":\"1\",\"configs\":{\"cardType\":\"direct\"}}]}";
    }
}
